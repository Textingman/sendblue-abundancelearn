    ...
    <footer className="text-white py-12" style={{ backgroundColor: '#0A2218' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Abundancelearn</h3>
            <p style={{ color: '#A7F3D0' }}>
              Your AI agent for smarter learning and financial abundance.
            </p>
            {/* Social Icons */}
          ...
          <div>
            ...
            <p style={{ color: '#A7F3D0' }}>support@abundancelearn.com</p>
            <p className="mt-2" style={{ color: '#A7F3D0' }}>8 The Green, Ste A, Dover, DE 19901</p>
            <p className="mt-2" style={{ color: '#A7F3D0' }}>NA</p>
          </div>
        </div>
        <div className="mt-8 pt-8 text-center" style={{ borderTop: '1px solid #113627', color: '#A7F3D0' }}>
